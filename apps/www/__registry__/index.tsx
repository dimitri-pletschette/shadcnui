...
export const Index: Record<string, any> = {
  "default": {
    ...
    "star-rating": {
      ...
      type: "components:ui",
      registryDependencies: undefined,
      component: React.lazy(() => import("@/registry/new-york/ui/star-rating")),
      files: ["registry/new-york/ui/star-rating.tsx"],
    },
    "table": {
      name: "table",
      type: "components:ui",
    ...
    "star-rating-demo": {
      ...
      type: "components:example",
      registryDependencies: ["star-rating"],
      component: React.lazy(() => import("@/registry/new-york/example/star-rating-demo")),
      files: ["registry/new-york/example/star-rating-demo.tsx"],
    },
    "star-rating-colored": {
      name: "star-rating-colored",
      type: "components:example",
      registryDependencies: ["star-rating"],
      component: React.lazy(() => import("@/registry/new-york/example/star-rating-colored")),
      files: ["registry/new-york/example/star-rating-colored.tsx"],
    },
    "star-rating-icon": {
      name: "star-rating-icon",
      type: "components:example",
      registryDependencies: ["star-rating"],
      component: React.lazy(() => import("@/registry/new-york/example/star-rating-icon")),
      files: ["registry/new-york/example/star-rating-icon.tsx"],
    },
    "switch-demo": {
      name: "switch-demo",
      type: "components:example",
